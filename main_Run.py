...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="lawn green", width=9, height=1,  activebackground ="Red", font=('times', 12, ' bold ')).pack()
    ...
    def fill_attendance():
        ...
        global sub
        sub = SUB_ENTRY.get()
        DB_table_name = str(sub + "_" + Date + "_Time_" +
        ...
        if sub == '':
            ...
            def create_csv():
                ...
                csv_name = r'E:/Attendace_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,r"E:\Techsaksmintern\Attendance Management System using Face Recognition-20241209T120729Z-001""')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            cascade_path = r"E:/Techsaksmintern/Attendance Management System using Face Recognition-20241209T120729Z-001/Attendance Management System using Face Recognition/haarcascade_frontalface_default.xml"
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                harcascadePath = r"E:\Techsaksmintern\Attendance Management System using Face Recognition-20241209T120729Z-001\Attendance Management System using Face Recognition\haarcascade_frontalface_default.xml"
                ...
                root.configure(background='grey80')
                cs = 'E:/Attendace_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"E:/Techsaksmintern/Attendance Management System using Face Recognition-20241209T120729Z-001/Attendance Management System using Face Recognition/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = r'E:/Techsaksmintern/Attendance Management System using Face Recognition-20241209T120729Z-001/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    global detector
    detector = cv2.CascadeClassifier(r"E:\Techsaksmintern\Attendance Management System using Face Recognition-20241209T120729Z-001\Attendance Management System using Face Recognition\haarcascade_frontalface_default.xml")
    try:
        global faces, Id
